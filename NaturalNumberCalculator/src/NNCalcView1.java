...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
         ...
         */
        JPanel mainpane1 = new JPanel(new GridLayout(
                MAIN_BUTTON_PANEL_GRID_ROWS, MAIN_BUTTON_PANEL_GRID_COLUMNS));
        /*
         * Add the buttons to the main button panel, from left to right and top
         * to bottom
         */
        mainpane1.add(this.bDigits[7]);
        mainpane1.add(this.bDigits[8]);
        mainpane1.add(this.bDigits[9]);
        mainpane1.add(this.bAdd);
        mainpane1.add(this.bDigits[4]);
        mainpane1.add(this.bDigits[5]);
        mainpane1.add(this.bDigits[6]);
        mainpane1.add(this.bSubtract);
        mainpane1.add(this.bDigits[1]);
        mainpane1.add(this.bDigits[2]);
        mainpane1.add(this.bDigits[3]);
        mainpane1.add(this.bMultiply);
        mainpane1.add(this.bDigits[0]);
        mainpane1.add(this.bPower);
        mainpane1.add(this.bRoot);
        mainpane1.add(this.bDivide);
        /*
         * Create side button panel
         */
        JPanel sidepane1 = new JPanel(new GridLayout(
         ...
         * to bottom
         */
        sidepane1.add(this.bClear);
        sidepane1.add(this.bSwap);
        sidepane1.add(this.bEnter);
        /*
         * Create combined button panel organized using flow layout, which is
         * simple and does the right thing: sizes of nested panels are natural,
         * not necessarily equal as with grid layout
         */
        JPanel combpane1 = new JPanel(new FlowLayout());
        /*
         * Add the other two button panels to the combined button panel
         */
        combpane1.add(mainpane1);
        combpane1.add(sidepane1);
        /*
